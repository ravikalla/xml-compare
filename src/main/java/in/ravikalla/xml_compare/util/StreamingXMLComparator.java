...
public class StreamingXMLComparator {
    private final static Logger logger = LogManager.getLogger(StreamingXMLComparator.class);
     ...
     */
    public static boolean compareXMLFilesStreaming(String xmlFile1, String xmlFile2, String outputFile) 
        ...
        try (FileInputStream fis1 = new FileInputStream(xmlFile1);
            ...
            logger.info("Streaming comparison completed. Files match: {}, Differences found: {}", 
                       filesMatch, differences.size());
